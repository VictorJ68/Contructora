...
export const AddImagenesObraComponent = () => {
    ...
    useEffect(() => {
        ...
        if (id) {
            imagenesObraService.getImagenesObraById(id).then((response) => {
                const imagenesObra = response.data;
                setDescripcion(imagenesObra.descripcion);
                if (imagenesObra.imagen) {
                    setPreview(`http://localhost:8060/Imagenes-contructora/${imagenesObra.imagen}`);
                }
            }).catch(error => {
                console.log("Error al obtener la imagen de la obra:", error);
            });
        }
    }, [id, idobra]);
    ...
    const saveImagenesObra = (e) => {
        ...
        if (id) {
            imagenesObraService.updateImagenesObra(formData).then(() => {
                alert("Se actualizó correctamente");
                navigate("/obras/imagenes/"+idobra);
            }).catch(console.error);
        } else {
            imagenesObraService.createImagenesObra(formData).then(() => {
                navigate("/obras/imagenes/"+idobra);
            }).catch(console.error);
        }
    }
    ...
    const title = id ? 'Actualizar Imagen' : 'Registro de Imagen';
    ...
    return (
        <div class="app-content">
            ...
            <div class="products-area-wrapper tableView">
                <div class="container">
                    <div class="content">
                        <form onSubmit={saveImagenesObra}>
                            <div class="user-details">
                                ...
                                <div className='button'>
                                    <button type="submit" onClick={(e) => saveImagenesObra(e)}  className="app-content-headerButton space-button">
                                        <div class="btnfrom">
                                    ...
                                    <Link to={`/obras/imagenes/${idobra}`} className='btn btn-danger mb-2'>
...
export default AddImagenesObraComponent;
