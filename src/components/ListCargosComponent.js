...
const ListCargosComponent = () => {
    ...
    const listarCargos = () => {
        cargosService.getAllCargos()
            .then(response => {
                ...
                setCargos(response.data); // <-- Guarda los datos en el estado
            })
            .catch(error => {
    ...
    const current = cargos; // Mostrar todos los datos sin paginación


    const deleteCargos = (id, nombre) => {
        if (window.confirm(`¿Estás seguro de eliminar el cargo "${nombre}"?`)) {
            cargosService.deleteCargos(id).then((response) => {
                listarCargos();
                alert("Cargo eliminada correctamente");
            }).catch(error => {
                console.log(error);
    ...
    return (
        <div className='app-content'>
            <div class="app-content-header">
                <h1 class="app-content-headerText">Cargos</h1>
            ...
            <div class="app-content-actions">
                ...
                <div class="app-content-actions-wrapper">
                    <Link to="/add-cargos"><button class="app-content-headerButton">Agregar Cargo</button></Link>
            ...
            <div class="products-area-wrapper tableView">
                <div class="products-header">
                    ...
                    <div class="product-cell status-cell">Descripcion<button class="sort-button">
                        <svg width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z"/></svg>
                    </button></div>
                ...
                {current.map(cargos => (
                    <div key={cargos.id} className="products-row">
                        ...
                        <div className="product-cell category"><span className="cell-label">Nombre:</span> {cargos.nombre}</div>
                        <div className="product-cell category"><span className="cell-label">Descripcion:</span> {cargos.descripcion}</div>
                        <div className="product-cell actions">
                            <Link to={`/edit-cargos/${cargos.id}`}>
                            ...
                            <button 
                                ...
                                title='Eliminar'
                                onClick={() => deleteCargos(cargos.id, cargos.nombre)}>
                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
export default ListCargosComponent;
