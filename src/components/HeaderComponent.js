    ...
    // <header>
        <div class="sidebar">
            <div class="sidebar-header">
                <div class="app-icon">
                    <img 
                        src="http://localhost:8060/Imagenes-contructora/LogoLAAJ.png"
            ...
            <ul class="sidebar-list">
                <li class="sidebar-list-item">
                    <a href="/">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                    <span>Home</span>
                    </a>
                </li>
                <li class="sidebar-list-item">
            ...
            {/* <nav class='navbar navbar-expand-md navbar-dark bg-dark'>
                <div>
                    <a href='/' className='navbar-brand' >Gestión de Futbolistas</a>
                </div>
            </nav> */}
        </div>
// </header>
